...
def main():
    ...
    # Epoch-level results
    df.to_csv(output_dir / f'{args.output_prefix}_epoch_level_orders.csv', index=False)
    ...
    subject_summary.to_csv(output_dir / f'{args.output_prefix}_subject_level_orders.csv')
    ...
    plt.savefig(output_dir / f'{args.output_prefix}_bic_analysis.png', dpi=300, bbox_inches='tight')
    plt.close()
